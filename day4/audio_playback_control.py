...
class MediaViewer:
    def __init__(self, root):
        self.root = root
        self.root.title("Media Player - Day 4")
        ...
        # --- NEW IN DAY 4: Speed Control Selector ---
        ...
        # Control Buttons Container (Including Skip Back / Skip Forward)
    ...
    # --- NEW IN DAY 4: Playback & Skipping Methods ---
    def play_media(self):
        selection = self.playlist_box.curselection()
        if not selection:
            return
    ...
    def change_speed(self, event):
        ...
        print(f"Speed modifier set to {speed_val}x (Ready for advanced engine integration)")
    # ------------------------------------------------
